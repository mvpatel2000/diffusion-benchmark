...
class StableDiffusion(composer.models.ComposerModel):
    ...
    def __init__(self, model_name: str = 'stabilityai/stable-diffusion-2-base'):
        ...
        if is_xformers_installed:
            from xformers.ops import MemoryEfficientAttentionCutlassFwdFlashBwOp
            self.unet.enable_xformers_memory_efficient_attention(MemoryEfficientAttentionCutlassFwdFlashBwOp)
